...
export default {
    ...
    menuInfos: [
        { title: '美食', icon: require('../images/Home/foodIcon.png') },
        { title: '电影', icon: require('../images/Home/movieIcon.png') },
        { title: '酒店', icon: require('../images/Home/hotelIcon.png') },
        { title: 'KTV', icon: require('../images/Home/KTVIcon.png') },
        { title: '优惠买单', icon: require('../images/Home/default.png') },
        { title: '周边游', icon: require('../images/Home/foottreatIcon.png') },
        { title: '生活服务', icon: require('../images/Home/ifeServiceIcon.png') },
        { title: '休闲娱乐', icon: require('../images/Home/entertainmentIcon.png') },
        { title: '丽人/美发', icon: require('../images/Home/beautyIcon.png') },
        { title: '购物', icon: require('../images/Home/shoppingIcon.png') },
